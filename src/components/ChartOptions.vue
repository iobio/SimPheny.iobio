    ...
    <div id="chart-options-container" :class="{ hidden: showComponent === false }">
        ...
        <div id="options-content">
            ...
            <div class="group zoom-to-select">
                ...
                <button v-if="!zoomed" @click="zoomToSelect()" :disabled="!selectedMatches || selectedMatches.length == 0">
        ...
        <div id="options-buttons">
            <button @click="applyFilters()" :disabled="!canApplyFilters()">
                Apply<v-icon v-if="zoomed">mdi-magnify-minus-outline</v-icon>
            </button>
